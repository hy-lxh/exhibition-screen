...
export default defineMock([
    ...
    },
    {
        ...
        body: {
            success: true,
            data: Array.from(new Array<Log>(12), () => ({
...

    {
        ...
        body: {
            success: true,
            data: [
                13640, 8240, 7840, 8380, 8312, 6652, 10224, 11241, 10519, 11838,
                10652, 10986,
            ].map((value, i) => ({
                value,
                name: i + 1 + '月',
...

    {
        ...
        body: {
            success: true,
            data: [120, 200, 150, 80, 70].map((value, i) => ({
                value,
                name: i + 2018 + '年',
            })),
        },
...

    {
        ...
        body: {
            success: true,
            data: [120, 200, 150, 80, 70, 110, 130, 170].map((value, i) => ({
                value,
                name: [
                    '本科院校',
                    '高职院校',
